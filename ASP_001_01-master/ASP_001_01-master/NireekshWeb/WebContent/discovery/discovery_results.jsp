					...
					<div class="row">
						...
						<ul id="nav" class="breadcrumb">
							...
							<div class="well">
								...
								<%! int count=0; String[] clr={"#fff","#0f0"}; %>
								
								<div id="result-row" style="color: <%=clr[(count++)%2] %>">
								
									<div id="parameter"><p>IP Address </p></div>
									
									<div id="parameter-value"><p><%=request.getParameter("start") %> </p></div>
									
								</div>
								
								<div id="result-row"  style="color: <%=clr[(count++)%2] %>">
									
									<div id="parameter"><p>Reachable </p></div>
									
									<div id="parameter-value"><p><%=request.getParameter("reachable") %> </p></div>
